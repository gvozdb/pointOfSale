...
class pointsOfSaleServiceCenterUploadProcessor extends modObjectProcessor
{
    ...
    public function process()
    {
        ...
        if (!empty($filename)) {
            ...
            if (!is_file($this->workFile)) {
                $error = $this->modx->lexicon('pointsofsale_service_center_file_nf');
            ...
            $msg = $this->modx->lexicon('pointsofsale_service_center_file_uploaded');
...
return 'pointsOfSaleServiceCenterUploadProcessor';
