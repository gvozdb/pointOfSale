pointsOfSale.formpanel.Default = function (config) {
    config = config || {};
    ...
    pointsOfSale.formpanel.Default.superclass.constructor.call(this, config);
};
Ext.extend(pointsOfSale.formpanel.Default, MODx.FormPanel, {
...
Ext.reg('pos-formpanel-default', pointsOfSale.formpanel.Default);
